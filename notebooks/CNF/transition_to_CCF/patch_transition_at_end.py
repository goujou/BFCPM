...
# # Plant 20-year difference continuous pine cover
...
sim_name = f"patch_transition_at_end_{sim_dict['species']}_{sim_dict['sim_length']}_{coarseness:02d}"
...
# ## Add clear cut at the beginning
...
sim_profile = "PTAEP" # just for logging
