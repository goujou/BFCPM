...
print(pre_spinup_date, pre_spinup_species, coarseness)
...
species = pre_spinup_species
light_model = "Zhao" # Zhao or Spitters
#pre_spinup_name = f"basic_{light_model}_{species}"
pre_spinup_name = f"DWC_{light_model}_{species}_{coarseness:02d}"
...
forcing = prepare_forcing(nr_copies=8, year_offset=-160, coarseness=coarseness)
