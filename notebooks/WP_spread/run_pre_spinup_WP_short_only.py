...
# # Simulation pre-spinup with short-lasting wood products only
#
...
empty_wood_product_model = ShortLastingOnlyWoodProductModel()
...
ax = next(axes)
ds.stocks.sel(entity="wood_product", pool=["WP_S"]).plot.line(ax=ax, x="time")
...
wood_product_model = ShortLastingOnlyWoodProductModel(
