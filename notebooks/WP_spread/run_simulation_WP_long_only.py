...
from BFCPM.wood_products.long_lasting_only_wood_product_model.C_model import \
    LongLastingOnlyWoodProductModel as WoodProductModel
...
wood_product_model = WoodProductModel(
